...
function Main() {
  ...
  const handleClick = () => navigate('/blogs/about_me');

  const art = {
    items: [
      {title: 'test 1', source: './thumbnails-0/test.png', page: '/blogs/blog_1'},
      {title: 'test 2', source: './thumbnails-0/test.png', page: '/blogs/blog_1'},
      {title: 'test 3', source: './thumbnails-0/test.png', page: '/blogs/blog_1'},
      {title: 'test 4', source: './thumbnails-0/test.png', page: '/blogs/blog_1'},
      {title: 'test 5', source: './thumbnails-0/test.png', page: '/blogs/blog_1'},
      {title: 'test 6', source: './thumbnails-0/test.png', page: '/blogs/blog_1'},
    ]
  }

  const architecture = {
    items: [
      {title: 'test 1', source: './thumbnails-1/test.png', page: '/blogs/blog_1'},
      {title: 'test 2', source: './thumbnails-1/test.png', page: '/blogs/blog_1'},
      {title: 'test 3', source: './thumbnails-1/test.png', page: '/blogs/blog_1'},
      {title: 'test 4', source: './thumbnails-1/test.png', page: '/blogs/blog_1'},
      {title: 'test 5', source: './thumbnails-1/test.png', page: '/blogs/blog_1'},
      {title: 'test 6', source: './thumbnails-1/test.png', page: '/blogs/blog_1'},
    ]
  }

  const programming = {
    items: [
      {title: 'test 1', source: './thumbnails-2/test.png', page: '/blogs/blog_1'},
      {title: 'test 2', source: './thumbnails-2/test.png', page: '/blogs/blog_1'},
      {title: 'test 3', source: './thumbnails-2/test.png', page: '/blogs/blog_1'},
      {title: 'test 4', source: './thumbnails-2/test.png', page: '/blogs/blog_1'},
      {title: 'test 5', source: './thumbnails-2/test.png', page: '/blogs/blog_1'},
      {title: 'test 6', source: './thumbnails-2/test.png', page: '/blogs/blog_1'},
    ]
  }
        ...
        <div className='slideshow'>
          <div className='slideshow__slide'
            ...
            {slides.map((item, item_number) => {
              return (<img key={item_number} src={item} className='slide'/>)
            })}
          </div>
        </div>
